...
export const buttonVariants = cva(
  ...
  "font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none " +
  "disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        ...
        icon:    "h-9 w-9 cursor-pointer", // 正方形图标按钮，用于承载图标
      },
    },
    defaultVariants: {
      variant: "default",
